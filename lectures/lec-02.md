...
![Event](https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/BPMN_plain_event_types.svg/2560px-BPMN_plain_event_types.svg.png)
...
```mermaid
graph TD
    Start([Стартова подія]) -->|Потік послідовності| Task1[Активність 1]
    Task1 --> Gateway{Ексклюзивний шлюзи}
    Gateway -->|Умова A| Task2[Активність 2]
    Gateway -->|Умова B| Task3[Активність 3]
    Task2 --> End1([Кінцева подія 1])
    Task3 --> End2([Кінцева подія 2])
```
